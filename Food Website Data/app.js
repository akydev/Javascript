...
// {/* <h4 class="price">${value.price.toFixed(0)}</h4> */}
...
const newButtons = menu.map(function(value){
  return `<button type="button" class="filter-btn" data-id="breakfast">
          ${value.category}
        </button>`;
});

document.getElementById("btn").innerHTML = newButtons.join(" ");
